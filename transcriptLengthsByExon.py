...
def main():
    ...
    print("Gene", "Transcript", "Length", "Exons", sep="\t", file=sys.stdout)
...
#            print("\tNum Exons:", transcript_exon_count, file=sys.stderr)
        ...
        print(gene_name, longest_transcript_name, longest_transcript_length, longest_transcript_exon_count, sep="\t", file=sys.stdout)
